...
- Use [`storage/books.mjs`](storage/books.mjs) for all app access to the book storage items; [`docs/storage.md`](docs/storage.md) defines their schema, validation, and cross-context serialization contract.
